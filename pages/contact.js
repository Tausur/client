...
const Contact = () => {
  ...
  const handleClick = async ()=>{
    try {
      await axios.post("http:localhost:3000/api/postContact",{name,email,message})
      ...
      <div className="container px-5 py-5 mx-auto flex sm:flex-nowrap flex-wrap">
        ...
        <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
          ...
          <div className="relative mb-4">
            ...
            <input value={name}  type="text" id="name" name="name" className="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"/>
          </div>
          <div className="relative mb-4">
