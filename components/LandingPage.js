...
const LandingPage = () => {
  ...
  return (
    <div className="w-full">
      <div className="bg-gradient-to-r from-cyan-500 to-blue-500 pb-1 mb-20">
        <div className="flex flex-col text-center w-full mb-20">
          <div className='text-white'>
            <h1 className="text-3xl text-black tracking-widest font-medium title-font mb-16 mt-16">Client Satellite</h1>
            <div className="flex justify-center">
              <div className="mb-3 xl:w-96">
                <div className="input-group relative flex w-full mb-4">
                  <input type="search" className="mr-1 form-control relative flex-auto min-w-0 block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded-xl transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" placeholder="Search" aria-label="Search" aria-describedby="button-addon2" />
                  <button className="shadow-xl btn inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 rounded-xl focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out items-center" type="button" id="button-addon2">
